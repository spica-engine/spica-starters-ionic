(self["webpackChunkspica_starters_ionic"] = self["webpackChunkspica_starters_ionic"] || []).push([["node_modules_ionic_core_dist_esm_ion-back-button_entry_js"],{
...
let BackButton = class {
  constructor(hostRef) {
    ...
    this.onClick = async (ev) => {
      ...
      return (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_3__.o)(this.defaultHref, ev, 'back', this.routerAnimation);
    };
  }
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el, ['aria-label']);
    if (this.defaultHref === undefined) {
      this.defaultHref = _ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonDefaultHref');
    }
  }
  get backButtonIcon() {
    ...
    if ((0,_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'ios') {
      ...
      return _ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonIcon', 'chevron-back');
    }
    // default md back button icon
    return _ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonIcon', 'arrow-back-sharp');
  }
  get backButtonText() {
    const defaultBackButtonText = (0,_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'ios' ? 'Back' : null;
    return this.text != null ? this.text : _ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonText', defaultBackButtonText);
  }
  get hasIconOnly() {
  ...
  render() {
    ...
    return ((0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, class: (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_3__.c)(color, {
        [mode]: true,
        'button': true,
      ...
      }) }, (0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: type, disabled: disabled, class: "button-native", part: "native", "aria-label": ariaLabel }, (0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "button-inner" }, backButtonIcon && (0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { part: "icon", icon: backButtonIcon, "aria-hidden": "true", lazy: false }), backButtonText && (0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { part: "text", "aria-hidden": "true", class: "button-text" }, backButtonText)), mode === 'md' && (0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", { type: this.rippleType }))));
  }
