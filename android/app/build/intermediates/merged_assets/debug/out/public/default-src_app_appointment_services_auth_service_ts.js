(self["webpackChunkspica_starters_ionic"] = self["webpackChunkspica_starters_ionic"] || []).push([["default-src_app_appointment_services_auth_service_ts"],{
...
/***/ 8142:
/*!******************************************************!*\
  !*** ./src/app/appointment/services/auth.service.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _bucket__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bucket */ 17308);
...
/* harmony import */ var _environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./environment */ 66346);
...
let AuthService = class AuthService {
    ...
    getUser(clean = false) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(this.getActiveToken()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.switchMap)((token) => token
            ? _bucket__WEBPACK_IMPORTED_MODULE_0__.employee.getAll({
...
/***/ 17308:
/*!************************************************!*\
  !*** ./src/app/appointment/services/bucket.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(function (client) {
    ...
    (function (realtime) {
        ...
        ;
    })(realtime = client.realtime || (client.realtime = {}));
})(client || (client = {}));
var appointment;
(function (appointment) {
    ...
    appointment.patch = patch;
    ;
    function remove(documentId) {
        return _spica_devkit_bucket__WEBPACK_IMPORTED_MODULE_0__.data.remove(BUCKET_ID, documentId);
    }
    appointment.remove = remove;
    ;
    let realtime;
    (function (realtime) {
        function get(...args) {
        ...
        realtime.getAll = getAll;
        ;
    })(realtime = appointment.realtime || (appointment.realtime = {}));
...
(function (employee) {
    ...
    (function (realtime) {
        ...
        realtime.getAll = getAll;
        ;
    })(realtime = employee.realtime || (employee.realtime = {}));
})(employee || (employee = {}));
var service;
(function (service) {
...
(function (branch) {
    ...
    (function (realtime) {
        ...
        realtime.getAll = getAll;
        ;
    })(realtime = branch.realtime || (branch.realtime = {}));
})(branch || (branch = {}));
var public_holiday;
...
/***/ 66346:
/*!*****************************************************!*\
  !*** ./src/app/appointment/services/environment.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const environment = {
    ...
    TOKEN_KEY: 'appointment_spica_token',
    EXPIRE_KEY: 'appointment_spica_expire',
...
//# sourceMappingURL=default-src_app_appointment_services_auth_service_ts.js.map