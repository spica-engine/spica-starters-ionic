...
export namespace user {
  const BUCKET_ID = '61b769c3b7f4a7002e04e414';
...
export namespace message {
  const BUCKET_ID = '61b769c6b7f4a7002e04e41d';
  export function get(...args: getArgs) {
  ...
  export function patch(document: Partial<Message> & id) {
    ['owner', 'chat'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => v._id || v)
...
export namespace chat {
  const BUCKET_ID = '61b769c5b7f4a7002e04e419';
  export function get(...args: getArgs) {
  ...
  export function patch(document: Partial<Chat> & id) {
    ['managers', 'last_message_owner'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => v._id || v)
