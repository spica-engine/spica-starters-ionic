...
export namespace teacher {
  ...
  export function patch(document: Partial<Teacher> & id) {
    ['speciality'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
...
export namespace video_packet {
  ...
  export function patch(document: Partial<Video_Packet> & id) {
    ['videos'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
...
export namespace video {
  ...
  export function patch(document: Partial<Video> & id) {
    ['category', 'teacher'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
...
export namespace food_program {
  ...
  export function patch(document: Partial<Food_Program> & id) {
    ['user', 'teacher'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
...
export namespace weekly_program {
  ...
  export function patch(document: Partial<Weekly_Program> & id) {
    return Bucket.data.patch(BUCKET_ID, document._id, document);
  }
  export function remove(documentId: string) {
    return Bucket.data.remove(BUCKET_ID, documentId);
  ...
  export namespace realtime {
    ...
    export function getAll(...args: realtimeGetAllArgs) {
      return Bucket.data.realtime.getAll<Weekly_Program & id>(
        BUCKET_ID,
        ...args
      );
    }
...
export namespace performance {
  ...
  export function patch(document: Partial<Performance> & id) {
    ['teacher', 'user'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
...
export namespace watched_video {
  ...
  export function patch(document: Partial<Watched_Video> & id) {
    ['video', 'user'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
  ...
  export namespace realtime {
    ...
    export function getAll(...args: realtimeGetAllArgs) {
      return Bucket.data.realtime.getAll<Watched_Video & id>(
        BUCKET_ID,
        ...args
      );
    }
...
export namespace teacher_speciality {
  ...
  export function patch(document: Partial<Teacher_Speciality> & id) {
    ['categories'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
  ...
  export namespace realtime {
    export function get(...args: realtimeGetArgs) {
      return Bucket.data.realtime.get<Teacher_Speciality & id>(
        BUCKET_ID,
        ...args
      );
    }
    export function getAll(...args: realtimeGetAllArgs) {
      return Bucket.data.realtime.getAll<Teacher_Speciality & id>(
        BUCKET_ID,
        ...args
      );
    }
...
export namespace training {
  ...
  export function patch(document: Partial<Training> & id) {
    ['packet', 'teacher', 'user'].forEach((field) => {
      if (typeof document[field] == 'object') {
        document[field] = Array.isArray(document[field])
          ? document[field].map((v) => (v._id ? v._id : v))
